...
| Gate | Prova |
|---|---|
| G1 lint/typecheck/unit/build/e2e verdes local | `npm run lint -- --max-warnings=0`, `npm run typecheck`, `npm test` (141), `npm run build`, `npm run test:e2e` (11) contra `dist/` e contra o `FRIGG.exe` portátil |
